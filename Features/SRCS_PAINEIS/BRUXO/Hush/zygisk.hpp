...
extern "C" __attribute__((visibility("default"), used)) void zygisk_module_entry(zygisk::internal::api_table *, JNIEnv *);

extern "C" __attribute__((visibility("default"), used)) void zygisk_companion_entry(int);
