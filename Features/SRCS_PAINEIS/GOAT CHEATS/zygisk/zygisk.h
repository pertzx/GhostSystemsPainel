...
A64HookFunction((void *)Il2CppGetMethodOffset(OBFUSCATE("Assembly-CSharp.dll"), OBFUSCATE("COW.GamePlay"), OBFUSCATE("PlayerAttributes"), OBFUSCATE("GetDashSpeedScale"), 1), (void *) _EXEMPLO, (void **) &EXEMPLO);
